...
This means one can have an always-on tunezd instance running, and another local tunezd/tunez-qt instance which connects to this node and receives blocks from it.
