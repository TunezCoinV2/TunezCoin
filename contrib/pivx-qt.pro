...
RESOURCES += src/qt/tunez.qrc src/qt/tunez_locale.qrc

TRANSLATIONS += src/qt/locale/tunez_bg.ts \
                src/qt/locale/tunez_de.ts \
                src/qt/locale/tunez_en.ts \
                src/qt/locale/tunez_es.ts \
                src/qt/locale/tunez_fi.ts \
                src/qt/locale/tunez_fr.ts \
                src/qt/locale/tunez_it.ts \
                src/qt/locale/tunez_ja.ts \
                src/qt/locale/tunez_pl.ts \
                src/qt/locale/tunez_pt.ts \
                src/qt/locale/tunez_ru.ts \
                src/qt/locale/tunez_sk.ts \
                src/qt/locale/tunez_sv.ts \
                src/qt/locale/tunez_vi.ts \
                src/qt/locale/tunez_zh_CN.ts \
                src/qt/locale/tunez_zh_TW.ts
