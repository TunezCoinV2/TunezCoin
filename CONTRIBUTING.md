Contributing to TunezNG (TUNEZ) Core
============================

The TUNEZ Core project operates an open contributor model where anyone is
...
The following applies to code changes to the TUNEZ Core project, and is not to be
confused with overall TUNEZ Network Protocol consensus changes.

Whether a pull request is merged into TUNEZ Core rests with the project merge
...
Patches that change TUNEZ consensus rules are considerably more involved than
...
Where a patch set proposes to change the TUNEZ consensus, it must have been
...
The project leader is the release manager for each TUNEZ Core release.
