                                                                            ...
                                                                            spinnerFrame(0)
{
    ...
    QString windowTitle = tr("TunezNG Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a TunezNG address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and tunez: URIs)"));
    ...
    privacyAction->setStatusTip(tr("Privacy Actions for zTUNEZ"));
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About TunezNG Core"), this);
    aboutAction->setStatusTip(tr("Show information about TunezNG Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for TunezNG"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your TunezNG addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified TunezNG addresses"));
    ...
    openAction->setStatusTip(tr("Open a TunezNG: URI or payment request"));
    openBlockExplorerAction = new QAction(QIcon(":/icons/explorer"), tr("&Blockchain explorer"), this);
    openBlockExplorerAction->setStatusTip(tr("Block explorer window"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the TunezNG Core help message to get a list with possible TunezNG command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("TunezNG Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to TunezNG network", "", count));
}
...
{
    QString strTitle = tr("TunezNG Core"); // default title
