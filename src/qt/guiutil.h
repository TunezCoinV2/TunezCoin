...
/** Utility functions used by the TunezNG Qt UI.
 */
namespace GUIUtil
{
...
// Render TunezNG addresses in monospace font
...
// Parse "tunez:" URI into recipient object, return true on successful parsing
