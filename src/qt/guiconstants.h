...
/* TUNEZ GUI -- Size of icons in status bar */
...
#define QAPP_ORG_NAME "TunezNG"
#define QAPP_ORG_DOMAIN "http://tunezng.io"
#define QAPP_APP_NAME_DEFAULT "TunezNG-Qt"
#define QAPP_APP_NAME_TESTNET "TunezNG-Qt-testnet"
