...
// Copyright (c) 2015-2018 The TUNEZ developers
...
void BootstrapDialog::setupUI()
{
    ...
    ui.labelTitle->setText(tr("TUNEZ Core can bootstrap the blockchain from the cloud or from a file. Please select an option and press Run."));
