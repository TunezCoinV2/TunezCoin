...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* TUNEZ features */
        {"tunez", "masternode", &masternode, true, true, false},
        {"tunez", "listmasternodes", &listmasternodes, true, true, false},
        {"tunez", "getmasternodecount", &getmasternodecount, true, true, false},
        {"tunez", "masternodeconnect", &masternodeconnect, true, true, false},
        {"tunez", "masternodecurrent", &masternodecurrent, true, true, false},
        {"tunez", "masternodedebug", &masternodedebug, true, true, false},
        {"tunez", "startmasternode", &startmasternode, true, true, false},
        {"tunez", "createmasternodekey", &createmasternodekey, true, true, false},
        {"tunez", "getmasternodeoutputs", &getmasternodeoutputs, true, true, false},
        {"tunez", "listmasternodeconf", &listmasternodeconf, true, true, false},
        {"tunez", "getmasternodestatus", &getmasternodestatus, true, true, false},
        {"tunez", "getmasternodewinners", &getmasternodewinners, true, true, false},
        {"tunez", "getmasternodescores", &getmasternodescores, true, true, false},
        {"tunez", "initmasternode", &initmasternode, true, true, false},
        {"tunez", "masternodeisinit", &masternodeisinit, true, true, false},
        {"tunez", "killmasternode", &killmasternode, true, true, false},
        {"tunez", "mnbudget", &mnbudget, true, true, false},
        {"tunez", "preparebudget", &preparebudget, true, true, false},
        {"tunez", "submitbudget", &submitbudget, true, true, false},
        {"tunez", "mnbudgetvote", &mnbudgetvote, true, true, false},
        {"tunez", "getbudgetvotes", &getbudgetvotes, true, true, false},
        {"tunez", "getnextsuperblock", &getnextsuperblock, true, true, false},
        {"tunez", "getbudgetprojection", &getbudgetprojection, true, true, false},
        {"tunez", "getbudgetinfo", &getbudgetinfo, true, true, false},
        {"tunez", "mnbudgetrawvote", &mnbudgetrawvote, true, true, false},
        {"tunez", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"tunez", "checkbudgets", &checkbudgets, true, true, false},
        {"tunez", "mnsync", &mnsync, true, true, false},
        {"tunez", "spork", &spork, true, true, false},
        {"tunez", "getpoolinfo", &getpoolinfo, true, true, false},
#ifdef ENABLE_WALLET
        {"tunez", "obfuscation", &obfuscation, false, false, true}, /* not threadSafe because of SendMoney */
...
{
    return "> tunez-cli " + methodname + " " + args + "\n";
}
...
std::string HelpExampleRpc(string methodname, string args)
{
    return "> curl --user myusername --data-binary '{\"jsonrpc\": \"1.0\", \"id\":\"curltest\", "
           "\"method\": \"" +
           methodname + "\", \"params\": [" + args + "] }' -H 'content-type: text/plain;' http://127.0.0.1:16413/\n";
}
