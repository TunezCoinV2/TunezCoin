...
// Copyright (c) 2017 The TunezNG developers
...
public:
    CMainParams()
    {
        ...
        nDefaultPort = 16511;
        bnProofOfWorkLimit = ~uint256(0) >> 20; // TunezNG starting difficulty is 1 / 2^12
        ...
        vSeeds.push_back(CDNSSeedData("tunez1", "seed.tunezcoinxt.org"));
        vSeeds.push_back(CDNSSeedData("tunez2", "seed.tunezng.org"));
        vSeeds.push_back(CDNSSeedData("tunez3", "seed.tunezt.net"));
        ...
        zerocoinModulus = "25195908475657893494027183240048398571429282126204032027777137836043662020707595556264018525880784"
            ...
            "8441436038339044149526344321901146575444541784240209246161651133507787077498171257724679629263863563732899121548"
        ...
        strBootstrapUrl = "https://tunezng.io/bootstrap/v1/main";
        //strBootstrapUrl = "https://bootstrap.tunezng.io/TUNEZ_Bootstrap.zip";
    }
...
public:
    CTestNetParams()
    {
        ...
        base58Prefixes[PUBKEY_ADDRESS] = std::vector<unsigned char>(1, 139); // Testnet tunez addresses start with 'x' or 'y'
        base58Prefixes[SCRIPT_ADDRESS] = std::vector<unsigned char>(1, 19);  // Testnet tunez script addresses start with '8' or '9'
        base58Prefixes[SECRET_KEY] = std::vector<unsigned char>(1, 239);     // Testnet private keys start with '9' or 'c' (Bitcoin defaults)
        // Testnet tunez BIP32 pubkeys start with 'DRKV'
        base58Prefixes[EXT_PUBLIC_KEY] = boost::assign::list_of(0x3a)(0x80)(0x61)(0xa0).convert_to_container<std::vector<unsigned char> >();
        // Testnet tunez BIP32 prvkeys start with 'DRKP'
        base58Prefixes[EXT_SECRET_KEY] = boost::assign::list_of(0x3a)(0x80)(0x58)(0x37).convert_to_container<std::vector<unsigned char> >();
        // Testnet tunez BIP44 coin type is '1' (All coin's testnet default)
        ...
        strSporkKey = "026ee678f254a97675a90ebea1e7593fdb53047321f3cb0560966d4202b32c48e2";
        strBootstrapUrl = "https://tunezng.io/bootstrap/v1/test";
        //strBootstrapUrl = "https://bootstrap.tunezng.io/TUNEZ_Bootstrap.zip";
    }
...
public:
    CRegTestParams()
    {
        ...
        nToCheckBlockUpgradeMajority = 1000;
        nMinerThreads = 1;
        nTargetTimespan = 24 * 60 * 60; // TUNEZ: 1 day
        nTargetSpacing = 1 * 60;        // TUNEZ: 1 minutes
        nPastBlocksMin = 200;
        bnProofOfWorkLimit = ~uint256(0) >> 1;
        genesis.nTime = 1454124731;
