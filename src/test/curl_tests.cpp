// Copyright (c) 2018 The TUNEZ developers
...
{
    string err1, out1;
    BOOST_CHECK(CURLGetRedirect("https://github.com/TunezCoinNG/TunezCoinNG/releases/latest", out1, err1));
...
{
    const CUrl url = "https://github.com/TunezCoinNG/TunezCoinNG/releases/download/v1.1.0_qt_downgrade/tunez-1.1.0.tar.gz";
