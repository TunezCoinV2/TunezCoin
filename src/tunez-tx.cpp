...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || mapArgs.count("-?") || mapArgs.count("-help")) {
        ...
        std::string strUsage = _("TUNEZ Core tunez-tx utility version") + " " + FormatFullVersion() + "\n\n" +
                               _("Usage:") + "\n" +
                               "  tunez-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded tunez transaction") + "\n" +
                               "  tunez-tx [options] -create [commands]   " + _("Create hex-encoded tunez transaction") + "\n" +
                               "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded tunez transaction
