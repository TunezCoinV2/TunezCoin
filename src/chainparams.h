...
{
    H1, // 1, Premine, Reward 2500 TUNEZ
    H2, // 151202, Reward 1250 TUNEZ
    H3, // 302401, Reward 1000 TUNEZ
    H4, // 388800, Reward 1500 TUNEZ, see-saw algorithm, new budget params and dev fund payments, only block version >= 4 is valid
    H5, // Zerocoin, only block version >= 5 is valid
    H6, // See-saw disabled, go back to 60% MN / 40% staker
    H7  // New budget Fee 25'000 TUNEZ
};

/**
 * CChainParams defines various tweakable parameters of a given instance of the
 * TunezNG system. There are three: the main network on which people trade goods
