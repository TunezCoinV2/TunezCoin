...
This mechanism has been integrated into Bitcore-Node-TUNEZ which allows for notification to be broadcast through Insight API in one of two ways:
* WebSocket: [https://github.com/TUNEZ-Project/insight-api-tunez#web-socket-api](https://github.com/TUNEZ-Project/insight-api-tunez#web-socket-api)
* API: [https://github.com/TUNEZ-Project/insight-api-tunez#swifttx-transactions](https://github.com/TUNEZ-Project/insight-api-tunez#swifttx-transactions)
...
By default, the TUNEZ Core daemon will launch using the following constant:

```
static const int DEFAULT_SWIFTTX_DEPTH = 5;
```

This value can be overridden by passing the following argument to the TUNEZ Core daemon:
