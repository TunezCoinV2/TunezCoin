...
In order to support loading of multiple wallets in tunez-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is tunez.cpp.
...
Changes to tunez.cpp
----------------------
tunez.cpp is the entry point into tunez-qt, and as such, will require some minor modifications to provide hooks for
